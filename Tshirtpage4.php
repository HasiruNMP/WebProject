...
<td class="tdpadding1">Price: </td> <td class="tdpadding2"><input class="hideborder" id="prices" name="prices" readonly="readonly"  value=Rs.<?php  echo  $row["Prices"]; }?>>  </td>
	...
	<tr>
		<td>
	<a href="Photos/pink front.JPG"><img class="timg" src="Photos/pink front.JPG"></a>
		</td>

		<td>
	<a href="Photos/pink rear.JPG"><img class="timg" src="Photos/pink rear.JPG"></a>
		</td>
	</tr>

	<tr>
		<td  id="thirdrow" colspan="2">
	<a href="Photos/pink right.JPG"><img id="thirdimg" src="Photos/pink right.JPG"></a>
		</td>
	</tr>
</table>
