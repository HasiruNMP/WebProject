...
<td class="tdpadding1">Price: </td> <td class="tdpadding2"><input class="hideborder" id="prices" name="prices" readonly="readonly"  value=Rs.<?php  echo  $row["Prices"]; }?>>  </td>
	...
	<tr>
		<td>
	<a href="../images/red front.JPG"><img class="timg" src="../images/red front.JPG"></a>
		</td>

		<td>
	<a href="../images/red rear.JPG"><img class="timg" src="../images/red rear.JPG"></a>
		</td>
	</tr>

	<tr>
		<td  id="thirdrow" colspan="2">
	<a href="../images/red right.JPG"><img id="thirdimg" src="../images/red right.JPG"></a>
		</td>
	</tr>
</table>
</div>
