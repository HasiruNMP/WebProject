...
<td class="tdpadding1">Price: </td> <td class="tdpadding2"><input class="hideborder" id="prices" name="prices" readonly="readonly"  value=Rs.<?php  echo  $row["Prices"]; }?>>  </td>
	...
	<tr>
		<td>
	<a href="../images/black 2 front.JPG"><img class="timg" src="../images/black 2 front.JPG"></a>
		</td>

		<td>
	<a href="../images/black 2 rear.JPG"><img class="timg" src="../images/black 2 rear.JPG"></a>
		</td>
	</tr>

	<tr>
		<td  id="thirdrow" colspan="2">
	<a href="../images/black 2 left.JPG"><img id="thirdimg" src="../images/black 2 left.JPG"></a>
		</td>
	</tr>
</table>
</div>
