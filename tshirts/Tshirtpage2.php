...
<td class="tdpadding1">Price: </td> <td class="tdpadding2"><input class="hideborder" id="prices" name="prices" readonly="readonly"  value=Rs.<?php  echo  $row["Prices"]; }?>>  </td>
	...
	<tr>
		<td>
	<a href="../images/black front.JPG"><img class="timg" src="../images/black front.JPG"></a>
		</td>

		<td>
	<a href="../images/black rear.JPG"><img class="timg" src="../images/black rear.JPG"></a>
		</td>
	</tr>

	<tr>
		<td  id="thirdrow" colspan="2">
	<a href="../images/black right.JPG"><img id="thirdimg" src="../images/black right.JPG"></a>
		</td>
	</tr>
</table>
</div>
