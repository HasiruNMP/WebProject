...
<td class="tdpadding1">Price: </td> <td class="tdpadding2"><input class="hideborder" id="prices" name="prices" readonly="readonly"  value=Rs.<?php  echo  $row["Prices"]; }?>>  </td>
	...
	<tr>
		<td>
	<a href="../images/blue front.JPG"><img class="timg" src="../images/blue front.JPG"></a>
		</td>

		<td>
	<a href="../images/blue rear.JPG"><img class="timg" src="../images/blue rear.JPG"></a>
		</td>
	</tr>

	<tr>
		<td  id="thirdrow" colspan="2">
	<a href="../images/blue right.JPG"><img id="thirdimg" src="../images/blue right.JPG"></a>
		</td>
	</tr>
</table>
</div>
