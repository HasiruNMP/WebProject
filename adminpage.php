...
<body>
	...
	<table class="nav clearfix" align="center">
      <tr>
        <td><button class="button clearfix" style="vertical-align:middle" onclick="adminlogin()"><span>Log Out</span></button></td>
        <td><button class="button clearfix" style="vertical-align:middle" onclick="orderpage()"><span>Check Orders</span></button></td>
      </tr>
    </table>
	</div>
